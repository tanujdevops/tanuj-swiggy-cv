      ...
      <div className={cn('relative ', className)} {...props}>
        <div className="absolute inset-0 z-40 overflow-hidden">
          <div
            ...
            invert
            filter
            will-change-transform [--aurora:repeating-linear-gradient(-100deg,var(--blue-500)_10%,var(--indigo-300)_15%,var(--blue-300)_20%,#FC8019_25%,var(--blue-400)_30%)] [--dark-gradient:repeating-linear-gradient(-100deg,#FC8019_0%,#FC8019_7%,var(--transparent)_10%,var(--transparent)_12%,#FC8019_16%)] [--white-gradient:repeating-linear-gradient(-100deg,var(--white)_0%,var(--white)_7%,var(--transparent)_10%,var(--transparent)_12%,var(--white)_16%)]
            ...
            after:[background-size:200%,_100%] dark:invert-0 dark:[background-image:var(--dark-gradient),var(--aurora)] after:dark:[background-image:var(--dark-gradient),var(--aurora)]`,
              ...
              showRadialGradient &&
                `[mask-image:radial-gradient(ellipse_at_100%_0%,#FC8019_10%,var(--transparent)_95%)]`,
            )}
          ></div>
        </div>
        {children}
